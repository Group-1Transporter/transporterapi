...
public class LoadsController {
	...
	@PostMapping("/create")
	public ResponseEntity<Loads> createLoads(@RequestBody Loads loads) {
		return loadsService.createLoads(loads);
	}
	
	@GetMapping("/all-load/{userId}")
	public ResponseEntity<ArrayList<Loads>> getAllLoads(@PathVariable("userId") String id){		
	...
	public ResponseEntity<ArrayList<Loads>> getConfirmLoads(@PathVariable("userId") String id){
		return loadsService.getConfirmLoads(id);
	}
	
	@GetMapping("/completed-load/{userId}")
	public ResponseEntity<ArrayList<Loads>> getCompletedLoads(@PathVariable("userId") String id){
